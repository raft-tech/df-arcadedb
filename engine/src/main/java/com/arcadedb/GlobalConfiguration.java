...
public enum GlobalConfiguration {
  ...
  MAX_PAGE_RAM("arcadedb.maxPageRAM", SCOPE.DATABASE, "Maximum amount of pages (in MB) to keep in RAM", Long.class, 4 * 1024,
      new Callable<>() {
        @Override
        public Object call(final Object value) {
  ...
  DF_CLASSIFICATION_URL("arcadedb.classificationRootUrl", SCOPE.SERVER, "DF-classification root URL", String.class, "http://localhost:8080"),
  ...
  KEYCLOAK_USER_CACHE_EXPIRE("arcadedb.keycloakUserCacheExpire", SCOPE.SERVER, "User cache expire ttl in ms", Long.class, 5000),
