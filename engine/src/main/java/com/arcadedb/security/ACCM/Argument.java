    ...
    public boolean evaluate(JSONObject json) {
        ...
        switch (operator) {
            ...
            case ANY_IN:
                ...
                System.out.println("Value: " + docFieldValue.toString() + "; vt: " + docFieldValue.getClass().getName());

                if (docFieldValue instanceof JSONArray) {

                    for (Object docVal :  ((JSONArray) docFieldValue).toList()) {

                        System.out.println("this.value: " + valueToString() + "; vt: " + this.value.getClass().getName());
