...
public class ServerSecurityDatabaseUser implements SecurityDatabaseUser {
  ...
  public ServerSecurityDatabaseUser(final String databaseName, final String userName, final String[] groups, final List<ArcadeRole> arcadeRoles, Map<String, Object> attributes, OpaPolicy policy) {
